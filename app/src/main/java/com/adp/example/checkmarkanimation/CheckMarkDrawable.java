...
public class CheckMarkDrawable extends Drawable {
    ...
    public static final Property<CheckMarkDrawable, Float> PROGRESS =
    ...
    public void draw(Canvas canvas) {
        ...
        final float shortBarLength = lerp(0, mShortBarSize, mProgress);
        final float shortBarWidth = (float) Math.cos(Math.toRadians(35f)) * shortBarLength;
        ...
        final float totalSize = 2.2f * mStrokeWidth + mLongBarSize;
        final float totalSizeDiff = mBounds.height() - totalSize;
